...
#data augmentation
cfg.DA=edict()
cfg.DA.border_prob=0.0
cfg.DA.sfactor=[4,4]
cfg.DA.imix=False
cfg.DA.imix_occrate=0.5
cfg.DA.imix_reverse_prob=0.3
cfg.DA.imix_epoch=40
cfg.DA.imix_interval=1
cfg.DA.mix_type=1
cfg.DA.norm_type='channel'
cfg.DA.update_bbox=False

cfg.CUTMIX=edict()
cfg.CUTMIX.prob=0.0
cfg.CUTMIX.occrate=0.5
# MODEL
cfg.MODEL = edict()
...
cfg.DATA.DATA_FRACTION = None # None means all data, could also use 1 here
