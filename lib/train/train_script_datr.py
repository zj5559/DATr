...
def run(settings):
    ...
    # Build dataloaders
    loader_train, loader_val = build_dataloaders_datr(cfg, settings)
    ...
    trainer = LTRTrainer(actor, [loader_train, loader_val], optimizer, settings, lr_scheduler=lr_scheduler,
                         imix=cfg.DA.imix,imix_epoch=cfg.DA.imix_epoch,imix_interval=cfg.DA.imix_interval,use_amp=use_amp)
